		...
		switch(blood_bled)
			...
			if(7 to 13)
				...
				if(limb.body_zone == BODY_ZONE_PRECISE_GROIN)
					if(prob(30))
						appendix.applyOrganDamage(20)
				if(limb.body_zone == BODY_ZONE_PRECISE_MOUTH)
					if(prob(30))
						tongue.applyOrganDamage(20)
					else if(prob(30))
			...
			if(14 to 19)
				...
				if(limb.body_zone == BODY_ZONE_PRECISE_GROIN)
					if(prob(40))
						appendix.applyOrganDamage(30)
				if(limb.body_zone == BODY_ZONE_PRECISE_MOUTH)
					if(prob(40))
						tongue.applyOrganDamage(30)
					else if(prob(40))
						vocal.applyOrganDamage(30)
				if(limb.body_zone == BODY_ZONE_PRECISE_FACE)
					if(prob(35))
			...
			if(20 to INFINITY)
				...
				if(limb.body_zone == BODY_ZONE_HEAD)
					if(prob(50))
						brain.applyOrganDamage(45)
				if(limb.body_zone == BODY_ZONE_CHEST)
					if(prob(50))
						lungs.applyOrganDamage(40)
					else if(prob(50))
						heart.applyOrganDamage(40)
					else if(prob(50))
						stomach.applyOrganDamage(40)
					else if(prob(50))
						liver.applyOrganDamage(40)
				if(limb.body_zone == BODY_ZONE_PRECISE_GROIN)
					if(prob(50))
						appendix.applyOrganDamage(40)
				if(limb.body_zone == BODY_ZONE_PRECISE_MOUTH)
					if(prob(50))
						tongue.applyOrganDamage(40)
					else if(prob(50))
						vocal.applyOrganDamage(40)
				if(limb.body_zone == BODY_ZONE_PRECISE_FACE)
					if(prob(45))
						brain.applyOrganDamage(40)
				if(limb.body_zone == BODY_ZONE_PRECISE_EYES)
					if(prob(50))
						eyes.applyOrganDamage(40)
