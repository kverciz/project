...
/obj/structure/sign/barsign/other
	name = "Вывеска"
	desc = "Здесь написано - SELLECK. Это же тот самый мужик!"
	icon = 'icons/obj/signsother.dmi'
	icon_state = "selleck"
	req_access = null
	max_integrity = 500
	integrity_failure = 0.5
	armor = list(MELEE = 30, BULLET = 30, LASER = 30, ENERGY = 100, BOMB = 0, BIO = 0, RAD = 0, FIRE = 60, ACID = 60)
	buildable_sign = FALSE
	panel_open = FALSE

/obj/structure/sign/barsign/other/set_sign(datum/barsign/sign)
	return

/obj/structure/sign/barsign/other/attack_hand(mob/user)
	return
